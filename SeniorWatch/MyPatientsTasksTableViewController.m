//
//  MyPatientsTasksTableViewController.m
//  SeniorWatch
//
...
@interface MyPatientsTasksTableViewController ()

@property (strong, nonatomic) NSMutableArray *myTasks;

@end

@implementation MyPatientsTasksTableViewController
...
-(void)getTasks{
    ...
    PFUser *user = (PFUser *)self.patient;
