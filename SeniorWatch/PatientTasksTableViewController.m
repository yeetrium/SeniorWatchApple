//
//  PatientTasksTableViewController.m
//  SeniorWatch
//
...
#import "PatientTasksTableViewController.h"
#import <Parse/Parse.h>
#import "TaskTableViewCell.h"

@interface PatientTasksTableViewController ()


@end

@implementation PatientTasksTableViewController

//lazy instantiation
-(NSMutableArray *)myTasks{
    if(!_myTasks){
        _myTasks = [[NSMutableArray alloc]init];
    }
    return _myTasks;
}
...
-(void)getTasks{
    ...
    [queryForTasks findObjectsInBackgroundWithBlock:^(NSArray *objects, NSError *error) {
        if(!error){
            self.myTasks = [objects mutableCopy];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PFObject *task = self.myTasks[indexPath.row];
